...
- **Aplicación de ejemplo 2 y 3.** La misma aplicación de tesorería montada con otra forma, para comparar sin cambiar de página: la 2 con menú flotante y claro y el buscador centrado (la plantilla 1 de la evaluación, solo con props de `AppShell`); la 3 en riel con el buscador centrado (la plantilla 3 con un solo nivel). El estilo visual se elige en el toolbar y se combina con cualquiera de las tres.
